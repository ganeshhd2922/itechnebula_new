...
include 'Mobile_Detect.php'; // Adjust the path as per your project's structure
    ...
    <div class="container ">
      <div class="row align-items-center">
        <div class="col-lg-6">
          ...
          <a href="./GetStarted/Gs_1.php"> <button class="border-0 mx-auto find-rjj mb-4 rounded-pill">Let’s Start Now</button></a>
